...
angular
    ...
    .provider('$socket', function () {
        ...
        function socketFactory($rootScope, $interval, $log, $timeout) {
            var self = this;
            ...
            self.initChannel = function (channel) {
                ...
                c.onmessage = function(msg) {
                    ...
                    if (!angular.isArray(msg) || msg.length !== 2) {
            ...
            self.sendChannelQueueMessages = function (channel) {
                if (channel && channel.connected && self.queue[channel.name].length) {
                    angular.forEach(self.queue[channel.name], function(msg, index) {
        ...
        socketFactory.$inject = ['$rootScope', '$interval', '$log', '$timeout'];
